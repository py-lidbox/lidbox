...
def loader(input_shape, num_outputs, output_activation="log_softmax"):
    ...
    x = SegmentLayer(512, name="frame2")(x)
    x = FrameLayer(512, 3, 2, name="frame3")(x)
    x = SegmentLayer(512, name="frame4")(x)
    x = FrameLayer(512, 3, 3, name="frame5")(x)
    x = SegmentLayer(512, name="frame6")(x)
    x = FrameLayer(512, 3, 4, name="frame7")(x)
    x = SegmentLayer(512, name="frame8")(x)
    x = SegmentLayer(512, name="frame9")(x)
    x = SegmentLayer(1500, name="frame10")(x)
